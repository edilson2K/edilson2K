...
1. **[Python Task Automator](https://github.com/edilson2K/-python-task-automator- ):** Script para automação de logs e organização de arquivos.
2. **[Static Site on AWS S3](https://github.com/edilson2K/static-site-aws-s3 ):** Hospedagem de site estático com CloudFront e SSL.
3. **[Estácio Study Notes](https://github.com/edilson2K/estacio-study-notes ):** Repositório organizado com exercícios e projetos acadêmicos (5º Semestre).

---

### 📫 Como me encontrar (Connect with me)
- 💼 [LinkedIn](https://www.linkedin.com/in/edilson-pereira-845138124/ )
- 📧 [Email](mailto:Edilson2kti@gamil.com)
- 🌍 [GitHub](https://github.com/edilson2K )
